...
# Test-NetConnection
# @see https://docs.microsoft.com/en-us/powershell/module/nettcpip/test-netconnection?view=win10-ps
Test-NetConnection global.bing.com -TraceRoute
Test-NetConnection -ComputerName www.searchsv.com.cn -Port 80 -InformationLevel Detailed
...
# Resolve-DnsName
# @see https://docs.microsoft.com/en-us/powershell/module/dnsclient/resolve-dnsname?view=win10-ps
Resolve-DnsName -name bt.neu6.edu.cn -NoHostsFile
# Resolves a name using only DNS. LLMNR and NetBIOS queries are not issued.
Resolve-DnsName -name bt.neu6.edu.cn -Server 223.5.5.5 -DnsOnly -NoHostsFile

...
function Set-AndroidAppos([String]$appName, [String]$opName, [String]$value) {
  if ($IS_DEBUG) { Write-Host "Will execute command: adb shell cmd appops set $appName $opName $value" }
...
# package: 'com.tencent.mm', 'com.taobao.taobao', 'com.tmall.wireless', 'com.taobao.etao', 'com.UCMobile' 
